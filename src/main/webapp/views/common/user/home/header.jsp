<%-- 
    Document   : header
    Created on : Oct 25, 2023, 12:22:42 PM
    Author     : Huu Huy
--%>
                    ...
                    <div class="header__top__right">
                        <div class="header__top__links">
                            ...
                            <c:if test="${sessionScope.customer != null}">
                                ...
                                <c:if test="${sessionScope.customer.roleId == '2'}">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6">
                <nav class="header__menu mobile-menu">
                    <ul>
                        <li><a action="home" href="${pageContext.request.contextPath}/home">Home</a></li>
            ...
            <div class="col-lg-3 col-md-3">
                <div class="header__nav__option">
                    ...
                    <a href="${pageContext.request.contextPath}/check-out"><img src="img/icon/cart.png" alt=""> <span>0</span></a>
